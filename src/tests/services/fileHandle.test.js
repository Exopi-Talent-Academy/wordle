...
export async function run(){
    ...
    assert.ok(allWords.includes(randomWord), "getRandomWord should return a word from the list");       
    ...
    assert.ok(words.length > 0, "readWordsFromFile should return a non-empty array");
}